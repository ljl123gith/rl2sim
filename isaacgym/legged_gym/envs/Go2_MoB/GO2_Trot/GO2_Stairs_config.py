...
class GO2_Stairs_Cfg_Yu( LeggedRobotCfg ):
    ...
    class init_state:
        ...
        default_joint_angles = {
            ...
            # # 添加 calflower 关节
            # 'FL_calflower_joint': 0.0,
            # 'FR_calflower_joint': 0.0,
            # 'RL_calflower_joint': 0.0,
            # 'RR_calflower_joint': 0.0,

            # # 添加 calflower1 关节
            # 'FL_calflower1_joint': 0.0,
            # 'FR_calflower1_joint': 0.0,
            # 'RL_calflower1_joint': 0.0,
            # 'RR_calflower1_joint': 0.0,
        }
