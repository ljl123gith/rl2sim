...
from legged_gym.envs.Go2_MoB.v1.v1_config import V1FlatCfg ,V1FlatCfgPPO
from legged_gym.envs.Go2_MoB.v1.v1_env import V1RobotFlat1
...
task_registry.register( "v1", V1RobotFlat1, V1FlatCfg(), V1FlatCfgPPO())
